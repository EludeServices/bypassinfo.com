...
.skill:nth-child(2) {
    transform: rotate(60deg) translateY(-27vh);
}

.skill:nth-child(3) {
    transform: rotate(120deg) translateY(-27vh);
}
...
.skill:nth-child(5) {
    transform: rotate(240deg) translateY(-27vh);
}

.skill:nth-child(6) {
    transform: rotate(300deg) translateY(-27vh);
}
